...
| Label | Reality |
|-------|---------|
| "On-chain investment" | Risk-free advance / demand loan |
| Return of capital | Guaranteed from Day-1 revenue |
| Upside | TROPTIONS keeps tokens |
| Downside | **Zero** if reimbursement is guaranteed |

No tier-1 exchange, Solana launchpad, or reputable VC structures capital this way.

---

## II. Market comparables (summary)

| Counterparty | Upfront from platform? | Reimbursement guarantee? |
|--------------|------------------------|---------------------------|
| Binance / Coinbase / Kraken | **No** — project pays $250K–$2M+ listing | **No** |
| Meteora / Jupiter LFG | Neutral protocol fees | **No** |
| Pump.fun / Bags.fm | Creator pays ~$2–3 SOL | **No** |
| a16z / Pantera SAFT | VC takes **risk** | **No** |
| Sketchy tier-2 "marketing packages" | Sometimes pay-to-play | Rarely labeled "reimbursable investment" |

---

## III. Three signals the MOU structure sends

1. **Undercapitalized issuer** — $10K advance from infrastructure partner instead of seed raise for audit/legal.
2. **Securities tripwire** — Guaranteed return of principal + others' efforts = *Howey* amplification; TROPTIONS looks like unregistered underwriter.
3. **Wash-trading appearance** — Buy volume Day 1, market as "exchange invested," make whole from treasury.
...
| Question | Answer |
|----------|--------|
| Would Binance / Coinbase do MOU §1.02? | **No** |
| Would Meteora / Jupiter? | **No** |
| Would institutional VC? | **No** (they take loss risk) |
| Should TROPTIONS sign MOU economics? | **No** — use Master Agreement Article 2 |
| Is current term sheet MOU-equivalent? | **No** — if recoup is fee-only and treasury reimbursement is excluded |
...
*Cross-reference: `STRATEGIC/UNIFIED_NEGOTIATION_POSITION.md`, `AI_SYSTEM/PROTOCOL_GOVERNANCE_PROMPT.md` (walk-away trigger on Day-1 treasury reimbursement).*
