# T-LEV-8 ↔ needai.unykorn.org Integration
...
<div className="mt-8 border rounded-lg overflow-hidden">
  <iframe
    src="https://fthtrading.github.io/T-Lev-8-/"
    style={{ width: '100%', height: '800px', border: 'none' }}
    title="T-LEV-8 Deal Room"
...
1. **Create route:** `needai/app/t-lev-8/page.tsx`
2. **Port the design:** Convert HTML to JSX components
3. **Connect to API:** Use your existing registry API for live data

Example component structure:
```tsx
// needai/app/t-lev-8/page.tsx
import { LiquidGlassLayout } from '@/components/TLev8/LiquidGlassLayout';
import { ConditionsTracker } from '@/components/TLev8/ConditionsTracker';
import { KillSwitchTerminal } from '@/components/TLev8/KillSwitchTerminal';
import { IPFSVault } from '@/components/TLev8/IPFSVault';

export default function TLev8Page() {
  return (
    <LiquidGlassLayout>
...
```tsx
<a
  href="https://fthtrading.github.io/T-Lev-8-/"
  target="_blank"
  rel="noopener noreferrer"
  className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
>
  <ExternalLink className="w-4 h-4" />
  Open T-LEV-8 Deal Room
</a>
```
