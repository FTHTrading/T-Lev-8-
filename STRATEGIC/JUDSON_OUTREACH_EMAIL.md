...
|----------|----------------|
| **MOU (May 16)** | Non-binding except confidentiality. The Day-1 reimbursement from "project funds, marketing budget, or initial fee revenue" is not acceptable in any binding form. |
| **Operating Agreement** | Real Wyoming LLC (filed March 18, 2026). Membership interests are described as restricted securities under the 1933 Act. This must be reconciled with the white paper before launch. |
| **White Paper 3.7** | Clear vision, but product and compliance items remain open (mint, audit, mandatory utility path, Wyoming filing proof, binding exchange agreements). |
...
### Diligence request (30 days)

Please provide:

1. Org chart and authority resolutions for LLC (and clarification vs. Judson Charles, Inc. on the MOU)  
2. Copy of February 16, 2026 developer MOU + termination/subordination plan  
3. Independent securities counsel Howey opinion (not issuer counsel alone)  
4. Plan to reconcile OA 1933 legend with utility token positioning  
5. Wyoming Utility Token Act filing stamp (W.S. § 34-29-106)  
6. Executed or binding BitMart / Poloniex agreements (not verbal summaries)  
7. SPL mint plan, multisig design, audit engagement letter  
8. Cap table and wallet map for 55% team/advisor allocation  
9. IP assignments to LLC  

### Next step

A 30-minute call to align on the Master Agreement and gate timeline. We are not asking you to accept the MOU as written — we are offering access to live exchange infrastructure on terms that match the risk each side actually carries.
...
| File | Send to Judson? | Notes |
|------|-----------------|-------|
| `LEGAL/MASTER_AGREEMENT.md` | **Yes** | Primary contract |
| `LEGAL/TOKEN_LISTING_POLICY.md` | Optional | Shows listing discipline |
...
1. MOU superseded — confidentiality only (5 min)  
2. $10K = integration advance, fee-only recoup (5 min)  
3. Exclusivity + CEX carve-out + 90-day metrics (5 min)  
...
*Not legal advice. Have counsel review before send.*
