...
| 5 | Fee share tiers only (60/40 → 50/50 → 40/60) | ✅ | ✅ |
| 6 | No $20K Net Fee recoup / Advance language | ✅ Absent | ✅ Absent |

**Result: PASS — safe to print and send** (counsel review still required for binding execution).

## After send — update `data/governance-state.json`

```json
"term_sheet_sent": "2026-05-21",
"term_sheet_version": "1.2",
"option_selected": "A"
```

Under `active_partner` object.
